...
// O CORS vive aqui, e nao num WebMvcConfigurer: com Spring Security ativo a
// cadeia de filtros intercepta a requisicao antes do MVC e a config do MVC nunca roda.
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Health check do Render — precisa responder sem autenticacao
