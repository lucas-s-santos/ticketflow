...
import com.canhoto.backend.dto.AuthResponseDto;
import com.canhoto.backend.dto.LoginRequestDto;
import com.canhoto.backend.dto.RegisterRequestDto;
import com.canhoto.backend.entity.User;
import com.canhoto.backend.exception.DuplicateResourceException;
import com.canhoto.backend.exception.ResourceNotFoundException;
import com.canhoto.backend.repository.UserRepository;
import com.canhoto.backend.security.JwtService;
...
public class AuthService {
    ...
    public AuthResponseDto register(RegisterRequestDto dto) {
        if (userRepository.existsByEmail(dto.email())) {
            throw new DuplicateResourceException("Email já está em uso: " + dto.email());
        }
